...
public class DraftyTest {
    ...
    public void testParse() {
        ...
        // URL, string 4
        actual = Drafty.parse("an url: https://www.example.com/abc#fragment and another _www.gfs.co_");
        expected = new Drafty("an url: https://www.example.com/abc#fragment and another www.gfs.com");
        expected.fmt = new Drafty.Style[]{
    ...
    public void testFormat() {
        ...
        src = new Drafty("an url: https://www.example.com/abc#fragment and another www.gfs.com");
        src.fmt = new Drafty.Style[]{
                new Drafty.Style("EM", 57, 13),
                new Drafty.Style(8, 36, 0),
                new Drafty.Style(57, 13, 1)
        ...
        expected = "an url: [https://www.example.com/abc#fragment](https://www.example.com/abc#fragment) "+
                "and another _[www.gfs.com](http://www.tinode.co)_";
