package com.gfs.messenger.services;
...
import com.gfs.messenger.Cache;
import com.gfs.messenger.TindroidApp;
...
import com.gfs.chatsdk.model.MetaGetSub;
...
class ContactsSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String ACCKEY_SYNC_MARKER = "com.gfs.messenger.sync_marker_contacts";
    private static final String ACCKEY_QUERY_HASH = "com.gfs.messenger.sync_query_hash_contacts";
