...
public class Const {
    ...
    public static final String INTENT_EXTRA_TOPIC = "com.gfs.messenger.TOPIC";
    public static final String INTENT_EXTRA_SEQ = "com.gfs.messenger.SEQ";
    public static final String INTENT_EXTRA_CALL_DIRECTION = "com.gfs.messenger.CALL_DIRECTION";
    public static final String INTENT_EXTRA_CALL_ACCEPTED = "com.gfs.messenger.CALL_ACCEPTED";
    public static final String INTENT_EXTRA_CALL_AUDIO_ONLY = "com.gfs.messenger.CALL_AUDIO_ONLY";
